...
// At initialization we bind to the relevent events on the 'Todos' collection, when items are added or changed.
initialize: function() {
...
// Add all items in the **Todos** collection all at once.
addAll: function() {
  this.$('#todo-list').html('');
...
// If you hit return in the main input field, create a new Todo model, persisting it to localStorage.
