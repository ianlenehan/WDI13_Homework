...
# Make sure the stops that are the same for different lines have different names (i.e. 23rd on the N and
# on the 6 need to be differentiated)

@n_line = ['Times Square', '34th', '28th', '23rd', 'Union Square', '8th']
require 'pry'

def plan_trip(start_stop, end_stop)
  binding.pry
  start = @n_line.index(start_stop)
  finish = @n_line.index end_stop
  puts "Stay on this train! It will take you to your destination"
trip = @n_line[start..finish].to_a
return trip
puts "You will pass through: #{trip.to_s}"
end
plan_trip("Times Square", "23rd")


#
# startindex = n_line.index "34th"
# subway[n_line].each do |station|
#   puts station
# end
# use range to show stations e.g. n_line[startindex..endindex]
